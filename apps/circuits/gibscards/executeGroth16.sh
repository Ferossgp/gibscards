...
# node ${OUTPUT}/${CIRCUIT}_js/generate_witness.js ${OUTPUT}/${CIRCUIT}_js/${CIRCUIT}.wasm input.json ${OUTPUT}/${CIRCUIT}_js/witness.wtns

echo "----- Generate .zkey file -----"
# Generate a .zkey file that will contain the proving and verification keys together with all phase 2 contributions
snarkjs groth16 setup ${OUTPUT}/${CIRCUIT}.r1cs ptau/powersOfTau28_hez_final_${PTAU}.ptau ${CIRCUIT}_0000.zkey
...
# snarkjs generatecall | tee ${OUTPUT}/parameters.txt

#move files
cp ${CIRCUIT}Verifier.sol ../../contracts/contracts/
cp ${OUTPUT}/${CIRCUIT}_js/${CIRCUIT}.wasm ../../contracts/zkproof/
cp ${CIRCUIT}_final.zkey ../../contracts/zkproof/
