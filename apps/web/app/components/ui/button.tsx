    ...
    "transition-all duration-200 ease-in-out transform -translate-y-1 -translate-x-1 hover:translate-x-0 hover:translate-y-0 disabled:translate-x-0 disabled:translate-y-0",),
  {
    variants: {
      variant: {
        ...
        outline:
          "border-2 border-neutral-900 bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
...
const containerVariants = cva(
  "",
  {
    variants: {
      variant: {
        default: "flex bg-neutral-800",
        destructive: "flex bg-neutral-800",
        outline: "",
        secondary: "flex bg-neutral-800",
        ghost: "",
        link: "",
      },
      size: {
